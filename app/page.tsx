  ...
  return (
    <div>
      ...
      <main className="no-print" style={{ padding: '20px', fontFamily: 'Arial, sans-serif', maxWidth: '1050px', margin: '0 auto', background: '#f1f5f9', color: '#1e293b', direction: 'ltr' }}>
        ...
        <div style={{ background: '#ffffff', border: '1px solid #cbd5e1', borderRadius: '6px', padding: '15px 20px', marginBottom: '15px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
          <div>
        ...
        <div style={{ background: '#ffffff', border: '1px solid #cbd5e1', borderRadius: '6px', padding: '15px 20px', marginBottom: '15px' }}>
          <h4 style={{ margin: '0 0 12px 0', fontSize: '13px', color: '#1e293b', borderBottom: '1px solid #e2e8f0', paddingBottom: '8px' }}>{freightMode === 'Sea LCL' ? 'LCL Rate and Charges Configuration' : 'Mixed Container Rates and Charges Configuration'}</h4>
